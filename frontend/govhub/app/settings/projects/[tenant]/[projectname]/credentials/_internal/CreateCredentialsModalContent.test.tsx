...
import { _internal } from '@/app/settings/projects/[tenant]/[projectname]/credentials/_internal/CreateCredentialsModalContent';
...
describe('errors', () => {
  ...
  it.each(errorTestCases)(
    'displays error messages regarding the credentials name for $testCase',
    ({ errors }) => {
