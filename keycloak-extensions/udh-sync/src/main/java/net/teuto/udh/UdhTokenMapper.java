...
import static net.teuto.udh.UdhResourceManagerKt.udhTokenMapperSetClaim;
...
public class UdhTokenMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
    ...
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, KeycloakSession keycloakSession, ClientSessionContext clientSessionCtx) {
        udhTokenMapperSetClaim(token, mappingModel, userSession, keycloakSession, clientSessionCtx);
    }
